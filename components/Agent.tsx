...
const Agent = ({userName, userId, type, interviewId, questions}: AgentProps) => {
    ...
    const handleCall = async () => {
        ...
        console.log(
            "Workflow ID:", process.env.NEXT_PUBLIC_VAPI_WORKFLOW_ID,
            "username:", userName,
            "userid:", userId
        )
        if (type === 'generate') {
            await vapi.start(
                /* assistantId */ null,
                /* assistantOverrides */ {
                    variableValues: {day: userName, userId: userId}
                },
                /* config        */ undefined,
    ...
    const isCallInactveOrFinished = callStatus === CallStatus.INACTIVE || callStatus === CallStatus.FINISHED;
